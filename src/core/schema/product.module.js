...
var Product = function () {
    ...
    var _soldCount_decorators;
    var _soldCount_initializers = [];
    var _soldCount_extraInitializers = [];
    ...
    var Product = _classThis = /** @class */ (function () {
        function Product_1() {
            ...
            this.soldCount = (__runInitializers(this, _barcode_extraInitializers), __runInitializers(this, _soldCount_initializers, void 0));
            this.isDeleted = (__runInitializers(this, _soldCount_extraInitializers), __runInitializers(this, _isDeleted_initializers, void 0));
    ...
    (function () {
        ...
        _stock_decorators = [(0, mongoose_1.Prop)({
                required: true,
                min: 0,
                default: 0
            })];
        _size_decorators = [(0, mongoose_1.Prop)({ trim: true })];
        _color_decorators = [(0, mongoose_1.Prop)({ trim: true })];
        _barcode_decorators = [(0, mongoose_1.Prop)({
                unique: true,
                sparse: true,
                trim: true
            })];
        _soldCount_decorators = [(0, mongoose_1.Prop)({ default: 0, min: 0 })];
        _isDeleted_decorators = [(0, mongoose_1.Prop)({ default: false, select: false })];
        ...
        __esDecorate(null, null, _soldCount_decorators, { kind: "field", name: "soldCount", static: false, private: false, access: { has: function (obj) { return "soldCount" in obj; }, get: function (obj) { return obj.soldCount; }, set: function (obj, value) { obj.soldCount = value; } }, metadata: _metadata }, _soldCount_initializers, _soldCount_extraInitializers);
