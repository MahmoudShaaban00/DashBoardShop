...
var product_module_1 = require("../../core/schema/product.module");
var jwt_1 = require("@nestjs/jwt");
var ProductModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [
                mongoose_1.MongooseModule.forFeature([{ name: product_module_1.Product.name, schema: product_module_1.ProductSchema }])
            ],
