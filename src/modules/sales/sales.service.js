...
var SalesService = function () {
    ...
    var SalesService = _classThis = /** @class */ (function () {
        function SalesService_1(saleModel, productModel, connection) {
            this.saleModel = saleModel;
            this.productModel = productModel;
            this.connection = connection;
        }
        // ✅ عملية البيع
        SalesService_1.prototype.sellProduct = function (productId, quantity) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            _a.sent();
                            return [4 /*yield*/, this.saleModel.create({
                                    product: product._id,
                                    quantity: quantity,
        ...
        // ✅ مبيعات يوم معين
        SalesService_1.prototype.getDailySales = function (date) {
            return __awaiter(this, void 0, void 0, function () {
                var start, end;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        // ✅ إجمالي مبيعات اليوم
        SalesService_1.prototype.getDailyTotal = function (date) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.saleModel.aggregate([
                                    {
                                        $match: {
                                            createdAt: { $gte: start, $lte: end }
                                        }
